...
public class DateData2 {
    ...
    public Map<String,Integer> today_info(DateData2 date_data) {
    ...
    public DateData2(String year, String month, String date, String value, Event[] event) { // 이벤트 스케줄 사용시 사용될 생성자
